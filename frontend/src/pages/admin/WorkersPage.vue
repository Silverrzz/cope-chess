    ...
    <section class="panel worker-panel">
      ...
      <div v-else-if="workers.length" class="table-scroll">
        <table class="data-table">
          <thead><tr><th>Machine worker</th><th>Status</th><th>Capacity</th><th>Machine</th><th>Last seen</th><th><span class="sr-only">Actions</span></th></tr></thead>
          <tbody>
...
.worker-panel { overflow: hidden; padding: 0; }.panel-heading { align-items: center; border-bottom: 1px solid var(--color-border, #d9e0ea); display: flex; gap: 1rem; justify-content: space-between; padding: .8rem .9rem; }.panel-heading h2 { font-size: .88rem; margin: 0; }.panel-heading p { color: var(--color-text-muted, #64748b); font-size: .68rem; margin: .2rem 0 0; }.panel-heading > span { background: var(--color-surface-subtle, #f1f5f9); border-radius: 999px; font-size: .68rem; padding: .25rem .5rem; }.table-scroll { overflow-x: auto; }.data-table { border-collapse: collapse; min-width: 60rem; width: 100%; }.benchmarker-table { min-width: 62rem; }.data-table th { color: var(--color-text-muted, #64748b); font-size: .65rem; letter-spacing: .04em; padding: .65rem .75rem; text-align: left; text-transform: uppercase; }.data-table td { border-top: 1px solid var(--color-border, #d9e0ea); font-size: .74rem; padding: .7rem .75rem; vertical-align: middle; }.worker-row--warning { background: color-mix(in srgb, var(--color-warning, #b7791f) 6%, transparent); }.data-table td:first-child a { color: inherit; display: grid; text-decoration: none; }.identity-cell strong { display: block; }.data-table small { color: var(--color-text-muted, #64748b); display: block; font-size: .64rem; margin-top: .15rem; }.data-table code { font-size: .68rem; }.state-label { background: var(--color-surface-subtle, #f1f5f9); border-radius: 999px; font-size: .66rem; padding: .28rem .45rem; }.row-actions { text-align: right; white-space: nowrap; }.row-actions > * + * { margin-left: .3rem; }.row-actions svg { fill: none; height: 1rem; stroke: currentColor; stroke-linecap: round; stroke-linejoin: round; stroke-width: 1.7; width: 1rem; }.index-loading { color: var(--color-text-muted, #64748b); min-height: 14rem; padding: 2rem; }.worker-pagination { align-items: center; border-top: 1px solid var(--color-border, #d9e0ea); display: flex; gap: .75rem; justify-content: flex-end; padding: .65rem .75rem; }.worker-pagination span { color: var(--color-text-muted, #64748b); font-size: .7rem; }
