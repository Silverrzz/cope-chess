    ...
    <section v-show="activeView === 'fixtures'" class="relay-section fixture-workspace">
      ...
      <div class="fixture-layout" :class="{ 'fixture-layout--building': showFixtureBuilder }">
        <form v-if="showFixtureBuilder" class="panel fixture-builder" @submit.prevent="createFixture">
          ...
          <label><span>Time · seconds</span><input v-model.number="fixtureForm.time_seconds" class="input" type="number" min="0.001" step="0.1"></label>
          <label><span>Increment · seconds</span><input v-model.number="fixtureForm.increment_seconds" class="input" type="number" min="0" step="0.1"></label>
