      ...
      <div class="fixture-layout" :class="{ 'fixture-layout--building': showFixtureBuilder }">
        ...
        <div class="fixture-list">
          <article v-for="fixture in payload.fixtures" :key="fixture.id" class="panel fixture-card">
            ...
            <div v-if="fixture.worker" class="fixture-worker"><AppIcon name="server" :size="14" /><span><strong>{{ fixture.worker.label }}</strong> is {{ fixture.tournament?.status === 'scheduled' ? 'reserved and preparing this fixture' : 'dedicated to this fixture' }}</span><StatusBadge :status="fixture.worker.status" /></div>
